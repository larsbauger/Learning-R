...
* En tabell generator for å gjøre det enklere å få fine tabeller. Bruk [denne](https://www.tablesgenerator.com/markdown_tables) lenken for å generere tabell. et eksempel på en 5x3 tabell under
...
For å introdusere en r chunk kan man bruke hurtigtastene `ctrl`+`alt`+ `i`. Under er det et kort seksempl på at jeg har lagd to variabler (vektorer): variabel x har verdiene fra 1-10 og y er har verdiene x ganger 3
```{r}
x = 1:10
y = x * 3
x + y
